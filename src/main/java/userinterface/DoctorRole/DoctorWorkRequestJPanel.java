...
public class DoctorWorkRequestJPanel extends javax.swing.JPanel {
     ...
     */
    public DoctorWorkRequestJPanel(JPanel userProcessContainer, DoctorWorkRequest request, UserAccount userAccount, EcoSystem business) {
        initComponents();
    ...
    public void populateTable() {
        ...
        DefaultTableModel model3 = (DefaultTableModel) tblHomelessPersonRecords3.getModel();
        ...
        if (request.getHomelessPerson() != null) {
            ...
            model1.addRow(row);
            Object[] rowSecond = new Object[10];
            ...
            Object[] rowThird = new Object[9];
            rowThird[0] = request.gethospitalAllocationWorkRequest().getSymptoms().toString();
            rowThird[1] = request.getHomelessPerson().getInterferonGammaLevel();
            rowThird[2] = request.getHomelessPerson().getWBC();
            rowThird[3] = request.getHomelessPerson().getNeutrophilis();
            rowThird[4] = request.getHomelessPerson().getHydrox();
            rowThird[5] = request.getHomelessPerson().getBloodPressure();
            rowThird[6] = request.getHomelessPerson().getDiabetes();
            
            model3.addRow(rowThird);
        }
    }
    ...
    private void initComponents() {
        ...
        txtFieldDiseases = new javax.swing.JTextArea();
        ...
        tblHomelessPersonRecords1.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 120, 1225, 100));

        tblHomelessPersonRecords2.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 1225, 100));

        jLabel2.setBackground(new java.awt.Color(255, 111, 97));
        jLabel2.setFont(new java.awt.Font("Serif", 1, 36)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Doctor Work Request");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(121, 6, 1110, -1));

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jLabel3.setText("Enter Detected Disease & Medicines Details");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 490, 469, -1));

        btnPassResults.setBackground(new java.awt.Color(181, 189, 137));
        btnPassResults.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        ...
        jPanel1.add(btnPassResults, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 700, 250, 50));

        btnFailResults.setBackground(new java.awt.Color(181, 189, 137));
        btnFailResults.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        ...
        jPanel1.add(btnFailResults, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 700, -1, 50));

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        jLabel5.setText("Person Details:");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 1225, 34));

        tblHomelessPersonRecords3.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        tblHomelessPersonRecords3.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Symptoms", "InterferonGammaLevel", "WBC", "Neutrophilis", "Hydrox", "BloodPressure", "Diabetes"
            }
        ));
        jScrollPane3.setViewportView(tblHomelessPersonRecords3);

        jPanel1.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, 1225, 100));

        txtFieldDiseases.setColumns(20);
        txtFieldDiseases.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        txtFieldDiseases.setRows(5);
        jScrollPane4.setViewportView(txtFieldDiseases);

        jPanel1.add(jScrollPane4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 520, 370, 140));
    ...
    private void btnFailResultsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFailResultsActionPerformed
        ...
        request.gethospitalAllocationWorkRequest().setTestResult("The request has been denied by Doctor");
    ...
    private void btnPassResultsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPassResultsActionPerformed
        ...
        if (!txtFieldDiseases.getText().equals("")) {
            diseases.add(txtFieldDiseases.getText());
        }
        request.setStatus("Completed");
    ...
    private javax.swing.JTextArea txtFieldDiseases;
