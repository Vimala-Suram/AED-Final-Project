...
public class ReportWorkRequestJPanel extends javax.swing.JPanel {
    ...
    public void populateTable() {
        ...
        if (request.getHomelessPerson() != null) {
            ...
            row[4] = request.getHomelessPerson().getEmailAddress();
            model1.addRow(row);
        }
    ...
    private void initComponents() {
        ...
        tblPersonRecords.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Income", "Dependents", "Contact Number", "Email"
            }
        ));
        ...
        jPanel1.add(downloadPdfBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 600, 250, 50));
        ...
        sendEmailButton.setBackground(new java.awt.Color(0, 102, 255));
        sendEmailButton.setFont(new java.awt.Font("Comic Sans MS", 1, 16)); // NOI18N
        ...
        jPanel1.add(sendEmailButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 600, 250, 50));
    ...
    private void sendEmailButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendEmailButtonActionPerformed
        // TODO add your handling code here:
        final String to = request.getHomelessPerson().getEmailAddress();

      // Sender's email ID needs to be mentioned
     final String from = "ashishtestingapps99@gmail.com"; //change accordingly to your email: 
        
        //Embedded account
       String username = "ashishtestingapps99@gmail.com";//change accordingly your email:
       String password = "etym dfng idbo jaux ";//change accordingly to your email password
    ...
    try {
        ...
        message.setSubject("Health report for " + request.getHomelessPerson().getName());
        ...
        // Add PDF metadata and content
        document.addTitle("Health Report PDF");
        document.addAuthor("Homeless Helpers");

        // Add content
        Paragraph preface = new Paragraph();
        preface.add(new Paragraph("Homeless Helpers Health Report"));
        preface.add(new Paragraph("\nHealth report for " + name.toUpperCase()
                + "\nStaying at: " + houseAddress
                + "\nHospital: " + hospitaltobeplaced
                + "\nDepartment: " + department
                + "\nSymptoms: " + symptoms
                + "\nDisease Details: " + diseasedetails
                + "\nRecommended Medicines: " + finalmedicines));
        document.add(preface);
        ...
        textPart.setText("Please find the attached health report PDF for " + name + ".");

        // PDF Attachment
        MimeBodyPart attachmentPart = new MimeBodyPart();
        DataSource pdfDataSource = new ByteArrayDataSource(pdfStream.toByteArray(), "application/pdf");
        attachmentPart.setDataHandler(new javax.activation.DataHandler(pdfDataSource));
        attachmentPart.setFileName("HealthReport_" + name + ".pdf");
        ...
        JOptionPane.showMessageDialog(null, "Email sent successfully with PDF attachment to:" + to);

    } catch (Exception e) {
        e.printStackTrace();
        JOptionPane.showMessageDialog(null, "Error sending email with PDF attachment.");
    }
