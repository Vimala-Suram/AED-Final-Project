...
public class ManageNetworkJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        networkJTable.setFont(new java.awt.Font("Trebuchet MS", 0, 16)); // NOI18N
        ...
        add(nameJTextField);
        nameJTextField.setBounds(116, 307, 257, 30);
        ...
        add(jLabel6);
        jLabel6.setBounds(120, 10, 807, 47);

        deleteButton.setBackground(new java.awt.Color(181, 189, 137));
        deleteButton.setFont(new java.awt.Font("Trebuchet MS", 1, 16)); // NOI18N
        deleteButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/delete.png"))
        );
        ...
        updateButton.setFont(new java.awt.Font("Trebuchet MS", 1, 16)); // NOI18N
