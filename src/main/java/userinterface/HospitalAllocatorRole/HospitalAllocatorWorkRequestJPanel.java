...
public class HospitalAllocatorWorkRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        hospital_allocator_select_hospitalComboBox.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        hospital_allocator_select_hospitalComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Massachusetts General Hospital - 275 Cambridge St, Boston, MA 02114", "Northside Hospital Atlanta - 1000 Johnson Ferry Rd NE, Atlanta, GA 30342", "Good Samaritan Hospital - 2425 Samaritan Dr, San Jose, CA 95124" }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            String imageUrl = "https://maps.googleapis.com/maps/api/staticmap?center=" + hospitaladdress + "&zoom=14&size=400x400&key=AIzaSyAZibiEg2MN4ssLmjz13_SfptH0bkgL4NA";
