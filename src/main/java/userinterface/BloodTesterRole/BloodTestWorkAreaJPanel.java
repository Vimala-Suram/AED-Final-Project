 ...
 * @author Sahithi
 */
public class BloodTestWorkAreaJPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private EcoSystem business;
    private UserAccount userAccount;
    private BloodTestOrganization organization;
    private Enterprise enterprise;

    /**
     * Creates new form LabAssistantWorkAreaJPanel
     */
    public BloodTestWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, BloodTestOrganization organization, EcoSystem business, Enterprise enterprise) {
        initComponents();
...
//        valueLabel.setText(enterprise.getName());
    ...
    public void populateSentTable() {
        ...
        for (WorkRequest request : userAccount.getWorkQueue().getWorkRequestList()) {
            DoctorWorkRequest wr = (DoctorWorkRequest) request;
    ...
    private void initComponents() {
        ...
        workRequestJTable.setFont(new java.awt.Font("Trebuchet MS", 0, 16)); // NOI18N
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, 1151, 151));

        assignJButton.setBackground(new java.awt.Color(181, 189, 137));
        assignJButton.setFont(new java.awt.Font("Trebuchet MS", 0, 16)); // NOI18N
        ...
        jPanel1.add(assignJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 300, 250, 50));

        processJButton.setBackground(new java.awt.Color(181, 189, 137));
        processJButton.setFont(new java.awt.Font("Trebuchet MS", 0, 16)); // NOI18N
        ...
        jPanel1.add(processJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 300, 250, 50));

        refreshJButton.setBackground(new java.awt.Color(181, 189, 137));
        refreshJButton.setFont(new java.awt.Font("Trebuchet MS", 0, 16)); // NOI18N
        ...
        jPanel1.add(refreshJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 300, 250, 50));

        SentWorkReqJTable.setFont(new java.awt.Font("Trebuchet MS", 0, 16)); // NOI18N
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 420, 1145, 151));
        ...
        enterpriseLabel.setText("BLOOD TEST REQUESTS");
        ...
        jLabel2.setText("Request received from Assistant Doctor");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 722, 20));

        jLabel3.setFont(new java.awt.Font("Trebuchet MS", 0, 16)); // NOI18N
        jLabel3.setText("List of Request sent by you to Doctor ");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 390, -1, -1));

        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1201, 750));
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        if (request.getReceiver() == userAccount) {
            ...
            BloodTestWorkRequestJPanel processWorkRequestJPanel = new BloodTestWorkRequestJPanel(userProcessContainer, request, userAccount, business);
            userProcessContainer.add("BloodTestWorkRequestJPanel", processWorkRequestJPanel);
