...
import static Business.PasswordValidator.validatePassword;
...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        createUserJButton.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        createUserJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/create.png"))
        );
        ...
        nameJTextField.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        ...
        userJTable.setFont(new java.awt.Font("Trebuchet MS", 0, 16)); // NOI18N
        ...
        employeeJComboBox.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        ...
        add(backjButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 120, 40));

        jLabel5.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        jLabel5.setText("Organization");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 306, -1, -1));

        organizationJComboBox.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        ...
        roleJComboBox.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        ...
        deleteJButton.setFont(new java.awt.Font("Trebuchet MS", 0, 18)); // NOI18N
        deleteJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/delete.png"))
        );
        ...
        updateJButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/update.png"))
        );
        ...
        add(passwordJTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 480, 200, 30));
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
        ...
        if (validatePassword(password)){
            ...
            JOptionPane.showMessageDialog(null, "Username" + userName + "Successfully added");
        } else {
            ...
            JOptionPane.showMessageDialog(null, "Make sure password has following:  \n - 8 characters long \n - 1 uppercase letter. \n - 1 lowercase letter. \n - 1 digit. \n- 1 special character.");
    ...
    private void updateJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateJButtonActionPerformed
        ...
        if (selectedRow >= 0) {
            if (validatePassword(passwordUpdated)) {
                int selectionButton = JOptionPane.YES_NO_OPTION;
