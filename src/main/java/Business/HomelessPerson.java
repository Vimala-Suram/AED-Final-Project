...
public class HomelessPerson {
    ...
    private static String InterferonGammaLevel;
    private static String WBC;
    private static String Neutrophilis;
    private static String Hydrox;
    ...
    public static String getInterferonGammaLevel() {
        return InterferonGammaLevel;
    }

    public static void setInterferonGammaLevel(String InterferonGammaLevel) {
        HomelessPerson.InterferonGammaLevel = InterferonGammaLevel;
    }

    public static String getWBC() {
        return WBC;
    }

    public static void setWBC(String WBC) {
        HomelessPerson.WBC = WBC;
    }

    public static String getNeutrophilis() {
        return Neutrophilis;
    }

    public static void setNeutrophilis(String Neutrophilis) {
        HomelessPerson.Neutrophilis = Neutrophilis;
    }

    public static String getHydrox() {
        return Hydrox;
    }

    public static void setHydrox(String Hydrox) {
        HomelessPerson.Hydrox = Hydrox;
    }
    ...
    public static void setBloodPressure(String BloodPressure) {
        HomelessPerson.BloodPressure = BloodPressure;
    }
    ...
    public static void setDiabetes(String Diabetes) {
        HomelessPerson.Diabetes = Diabetes;
    }
}
